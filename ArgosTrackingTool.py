...
#Ask user for a date
user_date = input("Please enter a date (m/d/yyyy): ")
...
for key in keys:
    ...
    lat = location[0]
    long = location[1]
    print(f"On {user_date}, Sarah was seen at {lat} deg. latitude and {long} deg. longitude.")